      ...
      flex-row items-start gap-5`}>
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I am a SRE/Systems Engineer working at YEXT. <br className="sm:block hidden" /> 
            I have experience working with both backend and frontend development languages and love to explore new technologies.
          </p>
        </div>
